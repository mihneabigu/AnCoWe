...
define(['Creature','Assets'],function(Creature,Assets){
    ...
    var DarkslashBoss = Creature.extend({
        ...
        tick:function(_dt){
            ...
            this.x=this.handler.getWorld().getEntityManager().getBoss3().getX()-21+Math.cos(this.angle)*70;
            this.y=this.handler.getWorld().getEntityManager().getBoss3().getY()-20+Math.sin(this.angle)*70;
