define(['Creature', 'Assets', 'HealthBar','Darkslashitem','Jadeslashitem','Explosionitem','Coin'], function (Creature, Assets, HealthBar, Darkslashitem, Jadeslashitem, Explosionitem,Coin) {
    ...
    var Bat = Creature.extend({
        ...
        takeDamage: function (_damage) {
            ...
            if (this.health <= 0) {
                ...
                //
                // if (randomSpawn > 0 && randomSpawn <=20 && this.spawnedItem == 0) {
                //     this.handler.getWorld().getEntityManager().addEntity(new Darkslashitem(this.handler, this.x, this.y));
                //     this.spawnedItem = 1;
                // }
                // else if (randomSpawn > 20 && randomSpawn <=40 && this.spawnedItem == 0) {
                //     this.handler.getWorld().getEntityManager().addEntity(new Jadeslashitem(this.handler, this.x, this.y));
                //     this.spawnedItem = 1;
                // }
                // else if (randomSpawn > 40 && randomSpawn <=60 && this.spawnedItem == 0) {
                //     this.handler.getWorld().getEntityManager().addEntity(new Explosionitem(this.handler, this.x, this.y));
                //     this.spawnedItem = 1;
                // }
