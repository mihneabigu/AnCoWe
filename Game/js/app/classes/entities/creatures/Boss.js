define(['Creature', 'Assets', 'HealthBar', 'Firespellitem','Firespellboss'], function (Creature, Assets, HealthBar, Firespellitem, Firespellboss) {
    ...
    var Boss = Creature.extend({
        init: function (_handler, _x, _y) {
            ...
            this.assets = Assets.getAssets("boss1");
            this.bounds.x = 20;
            this.bounds.y = 0;
            this.rand_dir = 0;
            this.dir_time = 0;
        ...
        getInputs: function (_dt) {
            ...
            if (this.alive == 1) {
                ...
                if(this.skillCooldown == 30){
                    this.skillCooldown = 0;
                    this.handler.getWorld().getEntityManager().addEntity(new Firespellboss(this.handler, this.x, this.y));
                }
        ...
        takeDamage: function (_damage) {
            ...
            if (this.health <= 0) {
                ...
                if (randomSpawn > 50 && this.spawnedItem == 0) {
                    this.handler.getWorld().getEntityManager().addEntity(new Firespellitem(this.handler, this.x, this.y));
                    this.spawnedItem = 1;
                }
