define(['Creature', 'Assets', 'HealthBar','DarkslashBoss','Darkslashitem'], function (Creature, Assets, HealthBar, DarkslashBoss, Darkslashitem) {



    var Boss3 = Creature.extend({
        init: function (_handler, _x, _y) {
            this._super(_handler, _x, _y, Creature.DEFAULT_CREATURE_WIDTH, Creature.DEFAULT_CREATURE_HEIGHT);
            this.assets = Assets.getAssets("boss3");
            this.bounds.x = 20;
            this.bounds.y = 0;
            this.rand_dir = 0;
            this.dir_time = 0;
        ...
        getInputs: function (_dt) {
            ...
            if (this.alive == 1) {
                ...
                this.skillCooldown++;
                if(this.skillCooldown == 120){
                    this.skillCooldown = 0;
                    this.handler.getWorld().getEntityManager().addEntity(new DarkslashBoss(this.handler, this.x, this.y));
                }
